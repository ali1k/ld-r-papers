...
We also make an argument that combining the LD-R components with LD-R scopes and configurations allow application assemblers to provide a high level of flexibility in their LDA UIs.
