...
The component interaction with SPARQL endpoints to retrieve and update Linked Datad occurs via invoking RESTful services in actions.
...
Microservices bring serveral performace and scalability advantages over monolithic applications which put all their functionality into a single process and scale by replicating the monolith on multiple servers.
