...
Due to the increasing amount of Linked Data openly published on the Web, user-facing Linked Data Applications (LDAs) driven by Semantic Web technologies are gaining momentum.
...
With the growing number of structured data published, the Web is moving towards becoming a rich ecosystem of machine-understandable Linked Data\footnote{\url{lodlaundromat.org} recently (14.10.2015) reported approx. 38.6 billion triples published on the Web.}.
...
Linked Data-driven (LD-R) Web components as defined in this paper are a species of Web component that employ the RDF data model for representing their content and specification (i.e. metadata about the component).
...
We used Github APIs\footnote{\url{https://developer.github.com/v3/}} to search\footnote{keywords: "Semantic Web" OR "Linked Data" OR "RDF" OR "SPARQL"} for Semantic Web repositories and to collect contact information for the corresponding contributors when available.
The search, after removing organizations and invalid email addresses, resulted in 650 potential Semantic Web developers.
...
\begin{itemize}
	...
	\item Datetime component: Manually typing datetimes in the required format (e.g. `2015-02-12T16:48:00Z') can be an error prone process. Instead, we have been able to reuse the \texttt{react-bootstrap-datetimepicker}\footnote{\url{https://github.com/quri/react-bootstrap-datetimepicker}} component, to create a new LD-R value editor for datetimes (BasicCalendarInput
...
We argue that bridging the gap between Semantic Web Technologies and Web Components worlds mutual benefits for both sides.
...
We would like to thank our colleagues from the KRR research group at VU University Amsterdam for their helpful comments during the development of the LD-Reactor framework. This work was supported by a grant from the European Union's 7th Framework Programme provided for the project RISIS (GA no. 313082).
