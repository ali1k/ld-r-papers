...
On the other hand, Web Components bring the advantages of UI standardization, reusibility, replacability and encapsulation to the current Semantic Web applications.
