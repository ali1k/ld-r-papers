...
With the growing number of structured data published, the Web is moving towards becoming a rich ecosystem of machine-understandable Linked Data\footnote{\url{lodlaundromat.org} recently (15.10.2015) reported approx. 38.6 billion triples published on the Web.}.
...
We would like to thank professor Peter van den Besselaar from the faculty of Social Sciences and our colleagues from the Knowledge Representation \& Reasoning research group at VU University Amsterdam for their helpful comments during the development of the LD-Reactor framework. This work was supported by a grant from the European Union's 7th Framework Programme provided for the project RISIS (GA no. 313082).
