...
\usepackage{algorithm2e}
% needed for correct representation of umlauts in listings
\lstset{literate=%
    {Ö}{{\"O}}1
    {Ä}{{\"A}}1
    {Ü}{{\"U}}1
...
\end{abstract}
%\textbf{\textit{Keywords}}: Vocabulary engineering, Supply Chain.
